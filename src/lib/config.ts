...
export const DATABASE_NAME = "beexprssNov18"
...
export const FROM_ME_FILTER_URL = "custom/awb/from_me/search/page/"
export const TO_ME_FILTER_URL = "custom/awb/to_me/search/page/"
...
export const CREATE_DRAFT_AWB_LIST = ""